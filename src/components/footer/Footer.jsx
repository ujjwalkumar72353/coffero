...
const Footer = () => {
  return (
     ...
     <div className='footer__content'>
      ...
      <ul className='footer__contact'>
          <li className='footer__contact-item'>
             <AiOutlinePhone className='icon' /> +91 7488377501
          </li>
          <li className='footer__contact-item'>
             <MdOutlineLocationOn className='icon' /> Patna,Bihar,india
          </li>
          <li className='footer__contact-item'>
             <FaRegEnvelope className='icon' /> ujjwalkumar4876@gmail.com
          </li>
   ...
   <p className='copyright__text'>
     &copy; Copyright 2023 <span>ujjwal</span> All Rights Reserved.
   </p> 
   </footer>
  )
}
